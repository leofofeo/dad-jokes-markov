const initialJSONData = require("./model-data");
...
const formatTableData = () => {
 return initialJSONData.then(initialJSONData => {
    const jokes = createJokeArray(initialJSONData);
    ...
    frequencyTable.forEach(key => {
      ...
      newFrequencyTable.push({ key: key, values: values });
    });
